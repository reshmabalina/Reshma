...
<table border='1' align='center'>
			...
			<tr>
			<td>Date</td>
			<td><input type='text' name='date' value=<%=expense.getFrom_date()%>></td>
			</tr>
			<tr>
			<td>Price</td>
			...
			<tr>
			<td>Total</td>
			<td><input type='text' name='total' value=<%=expense.getTotalAccount()%>></td>
			</tr>
			<tr>
			<td>By Whom</td>
			...
			// <!-- <a href='editExpenseStatus.html'>Save</a>
			// -->
		
					<td><input type='submit' value='Save' onclick='javascript:submitForm("EditExpensePostStatus.jsp")'></td>
			</td>
			</tr>
			</table>
